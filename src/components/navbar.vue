  ...
  <div id="navigationBar" class="container">
    <nav class="navbar fixed-top navbar-expand-sm navbar-light">
      <div class="container-fluid">
        ...
        <button
          class="navbar-toggler d-flex d-sm-none flex-column justify-content-around collapsed"
          type="button"
        ...
        <div class="navbar-collapse collapse" id="navbarNav" style="">
          <ul class="navbar-nav">
            ...
            <li class="nav-item-active">
              <a href="#" class="nav-link text-center"> Contact us </a>
            </li>
          </ul>
          ...
          v-if="store.user"
            ...
            id="login-link"
          >
            <a href="#" class="nav-link text-center"> Profile </a>
            <img
